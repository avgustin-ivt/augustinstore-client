          ...
          <div className="tp-product-action">
            <div className="tp-product-action-item d-flex flex-column">
              {isAddedToCart ? (
                ...
                >
                  <Cart /> <span className="tp-product-tooltip">Открыть Корзину</span>
                </Link>
              ) : (
                <button
                ...
                >
                  ...
                  <span className="tp-product-tooltip">Добавить в корзину</span>
                </button>
              )}
              <button
              ...
              >
                ...
                <span className="tp-product-tooltip">Просмотр</span>
              </button>
              <button
                type="button"
              ...
              >
                <Wishlist />
                <span className="tp-product-tooltip">Добавить в Избранное</span>
              </button>
            </div>
          </div>
        </div>
