...
const FashionTestimonial = () => {
  return (
    <>
      <section className="tp-testimonial-area grey-bg-7 pt-80 pb-80">
          ...
          <div className="row justify-content-center">
            <div className="col-xl-12">
              <div className="tp-testimonial-slider p-relative z-index-1">
                ...
                <h3 className="tp-testimonial-section-title text-center">Отзывы</h3>
                <div className="row justify-content-center">
                      ...
                      {fashion_testi_data.map(item => (
                        <SwiperSlide key={item.id} className="tp-testimonial-item text-center mb-20">
                          <div className="tp-testimonial-rating">
                            <span><Rating fillColor='#78ba52' readonly={true} allowFraction size={20} initialValue={item.review}/></span>
                          </div>
