        ...
        <div className="cartmini__wrapper d-flex justify-content-between flex-column">
          <div className="cartmini__top-wrapper">
                ...
                <div key={item._id} className="cartmini__widget-item">
                  ...
                  <div className="cartmini__content">
                    ...
                    <div className="cartmini__price-wrapper">
                      ...
                      <span className="cartmini__quantity">{" "} x {item.orderQuantity}шт</span>
                    </div>
                  </div>
            ...
            {cart_products.length === 0 && <div className="cartmini__empty text-center">
              ...
              <p><br /></p>
              <p>Корзина пуста</p>
              <Link href="/shop" className="tp-btn">В магазин</Link>
            </div>}
          </div>
          <div className="cartmini__checkout">
            ...
            <div className="cartmini__checkout-btn">
              <Link href="/cart" onClick={handleCloseCartMini} className="tp-btn mb-10 w-100"> Открыть корзину</Link>
              <Link href="/checkout" onClick={handleCloseCartMini} className="tp-btn tp-btn-border w-100"> Оплатить</Link>
            </div>
          </div>
        </div>
      </div>
